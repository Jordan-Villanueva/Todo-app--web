...
# The command to create the .exe file is
# pyinstaller --onefile --windowed --clean Experiment.py
...
add_button = sp.Button("Add", size=10, tooltip="Add Todo", key="Add")
