...
As you can see, the program first asks the user to enter a whole number. Then, once the user enters a number, the program asks
 the user again to enter another number.
...
module and what function of that module you can use to generate random numbers. While it is easy for me to provide some clues
here on what module you should use, searching for information and becoming familiar with programming community sites such as
Stackoverflow is part of the programming skillset you should acquire. Thus, it is essential to practice such skills as well
...
or use random.randint(lower_bound, upper_bound)
